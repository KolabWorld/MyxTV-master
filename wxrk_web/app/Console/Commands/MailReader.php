...
class MailReader extends Command
{
        ...
        try {
            ...
            //echo "<pre>";print_r($messages);exit;
                ...
                foreach($messages as $oMessage) {//echo "<pre>";print_r($oMessage->x_ham_report);exit;
                    ...
                    else if(isset($oMessage->bodies['text']))
                        $htmlContent = $oMessage->bodies['text'];
    ...
    //                if($emailId != "abhishekawasthi01@gmail.com"){
      //                 continue;
        //            }
                  //  echo "<pre>";print_r($oMessage->bodies);exit;
                  ...
                  // echo "==".$oMessage->bodies['html'];exit;
                    ...
                    if($pos !== false) {
                        ...
                        $ticketComment->comment = addslashes($htmlContent);
                    ...
                    //$supportTicket->message = $oMessage->getHTMLBody();
                                $supportTicket->message = addslashes($htmlContent);
                    $supportTicket->save();
