...
<html lang="en">
	<head>
		...
		<title>Icon Parking Systems</title>
		<link rel="stylesheet" href="{{ config('app.web_url_font') }}">
		<style>
			::selection{background:#ED8222;color:#fff}
			.home-btn:hover{background-color:#ED8222}
		</style>
		<style type="text/css">
			@media screen and (max-width:600px){
				table{width:100% !important;table-layout:fixed;border:0px!important;}
				.innerTable td{padding-left:20px!important;padding-right:20px!important;}
				.dataTable > tbody > tr > th,.dataTable > tbody > tr > td {padding:10px;display:block;display:table;}
				.dataTable > tbody > tr > th{border:0px;padding-bottom:0px;}
				.dataTable > tbody > tr > th + td {padding-top:0px;}
				.column{width:100%!important;display:block!important;border:0px!important;}
			}
		</style>
	</head>
	<body style="font-family:'Open Sans',sans-serif;color:#000;font-weight:500;text-rendering:optimizeLegibility;font-size:14px;word-break:break-word;-ms-word-break:break-word;margin:0;">
		<table border="0" cellpadding="0" cellspacing="0" height="100%" width="100%" id="bodyTable" bgcolor="#ececec" style="width:600px;max-width:100%;margin:auto;-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box;-webkit-box-shadow:0px 0px 4px 8px rgba(0,0,0,0.4);box-shadow:0px 0px 8px 4px rgba(0,0,0,0.4);background:#fff;">
			<tr style="-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box;">
				<td align="center" valign="top" style="-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box;">
					<table border="0" cellpadding="20" cellspacing="0" width="600" style="width:600px;max-width:100%;margin:auto;-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box;">
						<tr style="-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box;">
							<td align="center" valign="middle" bgcolor="#222222" style="box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;padding-left:40px;padding-right:40px;">
					...
					<table border="0" cellpadding="20" cellspacing="0" width="600" class="innerTable footer" bgcolor="#222222" style="box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;width:600px;max-width:100%;margin:auto;background:#fff;background:#222222;color:#fff;padding-top:0px;padding-bottom:0px;">
						...
						<tr style="box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;">
							<td align="center" valign="middle" style="box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;padding-left:40px;padding-right:40px;padding-top:10px;padding-bottom:10px;font-family:'Open Sans', 'Helvetica Neue', Helvetica, Arial, sans-serif;font-weight:normal;">
								<font face="'Open Sans', Helvetica, Arial, sans-serif">WE PARK NEW YORK</font>&trade;<br style="box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;"/>
