        ...
        <div class="container mt-4 mt-md-5">
            <div class="row justify-content-center">
                <div class="col-md-12 text-center">
                    <img src="/assets/admin/images/myx-logo.png" width="100px" class="login-logo" alt="" />
                </div>
                <div class="col-md-8">
                    <div class="login-bg">
                        <div class="row">
                            <div class="col-md-12">
                                <form autocomplete="off" id="login-form" method="POST"
                                    action="{{ route('admin-login') }}">
                                    @csrf
                                    <div class="head-title mb-4">
                                        <h2>Login</h2>
                                        <h5>Welcome to MyxTV</h5>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="materialLoginFormEmail">Email address</label>
                                                <input type="text" name="email" id="materialLoginFormEmail"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="password" name="password"
                                                    id="materialLoginFormInputPassword" class="form-control"
                                    ...
                                    <div class="row mt-2">
                                        <div class="col-6">
                                            <div>
                                                @if (isset($errorMessage) && $errorMessage)
                                                    <div class="form-group">
                                                        <h5 style="color:red; font-size:16px">{{ $errorMessage }}</h5>
                                                    </div>
                                                @endif
                                        ...
                                        <div class="col-6 text-right">
                                            <a href="/forget-password" class="forgetlink">Reset/Forgot Password</a>
                                        </div>
                                    </div>
                                    <div class="row justify-content-center">
                                        <div class="col-md-4">
