                        ...
                        <div class="col-lg-12">
                            <div class="myordersData">
                                ...
                                <div class="row mt-4">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="md-form">
                                            <input type="text" id="stitle11" name="bank_address" value="{{ old('bank_address')}}" placeholder="Enter here" class="form-control">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="md-form">
                                            <input type="text" id="stitle12" name="account_holder_name" value="{{ old('account_holder_name')}}" placeholder="Enter here" class="form-control">
