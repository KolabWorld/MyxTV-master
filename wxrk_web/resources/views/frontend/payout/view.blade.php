                          ...
                          <div class="col-sm-5 col-md-5">
                              <div class="filterarea">
                                  ...
                                  <div class="sortlink">
                                      ...
                                      <a href="{{ url('admin/payout-exports?designer_id=').$designer->id.'&'.Request::getQueryString() }}" class="text-dark"><img src="/assets/admin/img/export.svg"> Export Payouts</a>
                                  </div>
                              </div>
                          </div>
                      ...
                      <table class="table table-color table-bordered admintable border-0" cellspacing="0" cellpadding="0">
                        @foreach ($payouts as $key => $payout)
                          <tr>
                              ...
                              <td><strong>{{ $payout->designer ? $payout->designer->name : "-" }}</strong>Name</td>
                              <td><strong>$ {{ $payout->total_deducted_fee }} </strong>Total Fee Deducted</td>
                              <td><strong>$ {{ $payout->total_payout }}</strong>Total Payout</td>
