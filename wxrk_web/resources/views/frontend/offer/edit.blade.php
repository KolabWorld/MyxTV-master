            ...
            <div class="col-sm-12 col-md-12 col-12">
                <div class="tophead">
                    <div class="allTitle">
                        ...
                        <h2>Update Offer</h2>
                        <div class="subTitle">Update offers & assign designers and categories</div>
                    </div>
                    <div class="headpanel">
                        <div class="setting">
...
<form role="post-data" method="POST" redirect="/admin/offers/{{ $offer->id }}/edit" action="/admin/offers/{{ $offer->id }}" enctype="multipart/form-data">
                        ...
                        <div class="col-lg-12">
                            <div class="myordersData">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="md-form">
                                            <input type="text" name="title" placeholder="Enter the Title here" value="{{ $offer->title }}" class="form-control">
                                    ...
                                    <div class="col-sm-12 mt-2">
                                        <div class="form-group textarea-group">
                                            ...
                                            <textarea class="form-control" name="descriptions" rows="3">{{ $offer->descriptions }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <div class="card">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="mb-0">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-3 col-md-4">
                                                    <div class="md-form">
                                                        <input type="text" placeholder="Enter here" name="value" value="{{ $offer->value }}" class="form-control">
                                                        <label for="stitle">Value (%)</label>
                                                    </div>
                                                </div>
                                                <div class="col-lg-3 col-md-4">
                                                    <div class="md-form">
                                                        <input type="date" placeholder="Enter here" name="from_date" value="{{ $offer->from_date }}" class="form-control">
                                                        <label for="stitle">From Date</label>
                                                    </div>
                                                </div>
                                                <div class="col-lg-3 col-md-4">
                                                    <div class="md-form">
                                                        <input type="date" placeholder="Enter here" name="end_date" value="{{ $offer->end_date }}" class="form-control">
                                                        <label for="stitle">End Date</label>
                                                    </div>
                                                </div>
                                                <div class="col-lg-3 col-md-4">
                                                    <div class="md-form">
                                                        <input type="text" placeholder="Enter here" name="usage_limit" value="{{ $offer->usage_limit }}" class="form-control">
                                                        <label for="stitle">Usage limit</label>
                                                    </div>
                                                </div>
                                                <div class="col-lg-3 col-md-4">
                                                    <div class="md-form">
                                                        <input type="text" placeholder="Enter here" name="min_spend" value="{{ $offer->min_spend }}" class="form-control">
                                                        <label for="stitle">Min. Spend (USD)</label>
                                                    </div>
                                                </div>
                                                <div class="col-lg-3 col-md-4">
                                                    <div class="md-form">
                                                        <input type="text" placeholder="Enter here" name="max_spend" value="{{ $offer->max_spend }}" class="form-control">
                                            ...
                                            <div class="row my-2" style="display: {{ count($mappedProducts) > 0 ? '':'none' }}" id="specific_products">
                                                ...
                                                @foreach ($mappedProducts as $product)
                                                    <div class="col-md-3 col-6">
                                                        <input class="filled-in all-products" name="products[{{ $product->id }}]" value="{{ $product->id }}" type="checkbox" id="products_{{ $product->id }}" {{ is_array($offerableProducts) && in_array($product->id, $offerableProducts) ? 'checked' : '' }}>
