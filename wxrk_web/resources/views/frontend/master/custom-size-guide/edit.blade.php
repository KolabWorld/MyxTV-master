        ...
        <div class="row mb-2">
            <div class="col-sm-12">
                <div class="backbtnPanel">
                    ...
                    <div><button type="button" id="update" class="btn btn-sm btn-dark btn-auto">Update Video</button></div>
                </div>
            </div>
        </div>
...
<section class="content mb-5">
    <div class="container-fluid">
        <div class="row">
            ...
            {!! Form::open(['route' => ['custom-size-guide.update', $productSizeGuide->id], 'id'=>"post-data", 'method'=>'PUT', 'enctype' => 'multipart/form-data']) !!}
                <div class="row">
                    <div class="col-lg-12">
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-md-6">
                                    <video width="100%" muted style="object-fit: cover; display:{{ isset($productSizeGuide->media[0]) && $productSizeGuide->media[0]->mime_type =='video/mp4' ? '' :'none;'}}" class="video_upload_preview" controls>
                                        <source id="video_upload_preview" src="{{ $productSizeGuide->attachment_url ? $productSizeGuide->attachment_url :'' }}">
                                    </video>
                                    <img id="image_upload_preview" style="display:{{ isset($productSizeGuide->media[0]) && $productSizeGuide->media[0]->mime_type !='video/mp4' ? '' :'none;'}}" src="{{ $productSizeGuide->attachment_url ? $productSizeGuide->attachment_url :'/assets/admin/img/image.svg' }}" class="border w-100" />
                                </div>
                            </div>
                        </div>
                    </div>
