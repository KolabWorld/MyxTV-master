...
{{-- Web site Title --}}
@section('title') Notification :: @parent @stop
@section('content')

@include('frontend.partials.nav',['title'=> 'Notification' ,'description'=> 'Total Records '. $records->total() .''])
            ...
            <div class="col-md-12">
                <div class="row align-items-center"> 
                    <div class="col-8 pl-0 col-md-8 text-right">
                        <a href="/notifications/create" class="btn btn-secondary btn-filter mr-2">
                                        ...
                                        <tbody>
                                            @foreach ($records as $key => $record)
                                                <tr>
                                                    ...
                                                    <td>
                                                        {{$record->equipment_detail_type}}
                                                    </td>
                                                    <td>
                                                        {{$record->equipmentDetail->equipment_number}}
                                                    </td>
                                                    <td>
                                                        {{$record->admin_type}}
                                                    </td>
                                                    ...
                                                    <td>
                                                        <a href="/notification/{{ $record->id }}/view" class="btn btn-sm btn-outline-dark">
                                                            <i class="fas fa-eye"></i>
                                                        </a> 
                                                        <!-- <a href="#" data-url="/notification/{{ $record->id }}/delete" data-request="remove" data-redirect="/notification" class="btn btn-sm btn-outline-dark">
