        ...
        <div class="row mb-2">
            <div class="col-sm-12">
                <div class="backbtnPanel">
                    ...
                    <div><button type="button" id="save" class="btn btn-sm btn-dark btn-auto">Add Size Guide</button></div>
                </div>
            </div>
        </div>
...
<section class="content mb-5">
    <div class="container-fluid">
        <div class="row">
            ...
            {!! Form::open(['action' => 'Admin\Master\ProductSizeGuideController@store', 'id'=>"post-data", 'method'=>'POST', 'enctype' => 'multipart/form-data']) !!}
                <div class="row">
                    <div class="col-lg-12">
                        <div class="myordersData">
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="md-form">
                                        <input type="text" id="stitle" placeholder="Enter the Title here" name="title" value="{{ old('title') }}" class="form-control" value="Title of the Image">
                            ...
                            <div class="row mt-4">
                                <div class="col-md-6">
                                    <div class="md-form upload-btn-wrapper2">
                                        <input type="file" accept="image/gif, image/jpeg, image/png, video/mp4, video/mov, video/avi" id="inputFile" placeholder="Enter the Title here" class="form-control" name="size_image" value="Title of the Image">
