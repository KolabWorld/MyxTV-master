...
{{-- Web site Title --}}
@section('title') Create QR Codes :: @parent @stop
@section('content')

@include('frontend.partials.nav',['title'=>'QR Codes','description'=> (isset($qrCode) && $qrCode->id) ? 'Edit' : 'Add'])
<section class="content mb-3">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                {!! Form::model($qrCode, ['method' => isset($qrCode) && $qrCode->id ? 'put' : 'post']) !!}
