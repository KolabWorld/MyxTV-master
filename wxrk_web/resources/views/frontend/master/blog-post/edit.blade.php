            ...
            <div class="col-sm-12 col-md-12 col-12">
                <div class="tophead">
                    <div class="allTitle">
                        ...
                        <h2>Update Blog</h2>
                        <div class="subTitle">Update Blog & categories</div>
                    </div>
                    <div class="headpanel">
                        <div class="setting">
            ...
            <div class="col-sm-12">
                <div class="backbtnPanel nonflex">
                    ...
                    <div>
                        ...
                        <button type="button" id="update" class="btn btn-sm btn-dark btn-auto">Update Blog Post</button>
                    </div>
                </div>
            </div>
        </div>
...
<form role="post-data" method="POST" redirect="/admin/blog-posts/{{ $blogPost->id }}/edit" action="/admin/blog-posts/{{ $blogPost->id }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="designer_id" id="designer_id" required="">
                                    @foreach ($designers as $designer)
                                        <option value="{{$designer->id}}" {{ ($blogPost->designer && ($blogPost->designer->id == $designer->id)) ? 'selected':'' }}>{{ ucfirst($designer->name) }}</option>
                                    @endforeach
                                </select>
                            </div>
                            @error('designer_id')
                        ...
                        <div class="col-lg-12">
                            <div class="myordersData">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="md-form">
                                            <input type="text" id="stitle" name="title" value="{{ $blogPost->title }}" placeholder="Enter the Title here" class="form-control">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group textarea-group">
                                            ...
                                            <textarea class="form-control" name="description" id="exampleFormControlTextarea1" placeholder="Enter the long here" rows="3">{{ $blogPost->description }}</textarea>
                                        </div>
                                        @error('description')
                                            <label class="label">
                                                <strong class="text-danger"> {{ $message }}</strong>
                ...
                @if($blogPost->status != 'pending')
                                ...
                                <div class="form-group">
                                    <select class="form-control" id="status" name="status">
                                        <option value="">Please select</option>
                                            <option value="active" @if($blogPost->status == 'active') selected @endif>Active</option>
                                            @if($blogPost->show_on_home == "0")
                                                <option value="inactive" @if($blogPost->status == 'inactive') selected @endif>In Active</option>
                                            @endif
                                    </select>
                                </div>
                            </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <img src="{{ $blogPost->featured_image ? $blogPost->featured_image :'/assets/admin/img/image.svg' }}" id="preview_featured" class="border w-100 mb-2" style="display:{{ $blogPost->featured_image ? '' :'none' }}">
                                </div>
                            </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <input class="filled-in" name="category_id" {{  $blogCategory->id ==  $blogPost->category_id ? 'checked' : '' }} value="{{ $blogCategory->id }}" type="radio" id="cat_{{ $blogCategory->id }}">
