            ...
            <div class="col-sm-12 col-md-12 col-12">
                <div class="tophead">
                    <div class="allTitle">
                        ...
                        <h2>Add Product</h2>
                        <div class="subTitle">Add product, categories, sub-categories & attributes</div>
                    </div>
                    <div class="headpanel">
                        <div class="setting">
            ...
            <div class="col-sm-12">
                <div class="backbtnPanel nonflex">
                    ...
                    <div>
                        ...
                        <a id="save" class="btn btn-sm btn-dark btn-auto">Publish Product</a>
                    </div>
                </div>
            </div>
        </div>
...
<form role="post-data" method="POST" redirect="/admin/products" action="/admin/products" enctype="multipart/form-data">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group textarea-group">
                                            ...
                                            <textarea class="form-control" name="short_description"
                                                id="exampleFormControlTextarea2" placeholder="Enter the desctipion here"
                                        ...
                                        <div class="mb-0">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="allTitle">
                                                        <h2>Attributes</h2>
                                                        <div class="subTitle mb-3">Add attributes, variables and images
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 textM-right mt-2">
                                                    <a href="{{ url('admin/product-attributes') }}" target="_blank"
                                                        class="btn btn-md btn-dark btn-auto mb-0 waves-effect waves-light ">Add
                                                        More Attributes</a>
                                                </div>
                                                    ...
                                                    <div class="card">
                                                        ...
                                                        <div class="card-body">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <div>
                                                                        <input class="filled-in productAttributes" type="checkbox" data-title="{{ $productAttribut->name }}" data-id="{{ $productAttribut->id }}" data-type="{{ $productAttribut->type }}" value="{{ json_encode($productAttribut->productAttributeVariables) }}" name="product_attributes" id="productAttribut_{{ $productAttribut->id }}">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="accordianPanel">
                                                        <h5 class="mb-2 accordTitle">
                                                            <a class="colapseClickmoew playfair" data-toggle="collapse"
                                                                data-target="#cat0" role="button" aria-expanded="false"
                                                                aria-controls="cat0">
                                                                Generated Variables
                                                            </a>
                                                        </h5>
                                                        <div class="collapse show" id="set_generated_attributes">
                                                        ...
                                                        <!-- <h5 class="accordTitle mb-0">
                                                            <a class="colapseClickmoew playfair" data-toggle="collapse"
                                                                data-target="#cat1" role="button" aria-expanded="false"
                                                                aria-controls="cat1">
                                                                Attribute: Monogram
                                                            </a>
                                                        </h5>
                                                        ...
                                                        <div class="collapse show" id="cat1">
                                                            <div class="row">
                                                                <div class="col-lg-2">
                                                                    <div class="md-form">
                                                                        <input type="text" id="stitle" placeholder="Cost"
                ...
                <section class="col-lg-4 connectedSortable">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <img src="/assets/admin/img/image.svg" id="preview_hover_featured" class="border w-100 mb-2" style="display: none">
                                    {{-- <a href="#" class="delImageNew mr-1"><img src="/assets/admin/img/closered.svg" width="25" /></a> --}}
                                </div>
                            </div> 
                            <div class="upload-btn-wrapper">
                                <button class="uploadBtn">Upload Featured Hover Image</button>
                                <input type="file" accept="image/*" name="featured_hover_image" onchange="renderImage(this, 'preview_hover_featured')">
                            </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="upload-btn-wrapper">
                                ...
                                <input type="file" accept="image/*" name="other_images[]" multiple id="other_image">
                            </div>
                            @error('other_image')
                            <label class="label">
                                <strong class="text-danger"> {{ $message }}</strong>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12" id="videoUploadRemove">
                                    <video width="100%" class="videoUpload" height="200" controls="" style="object-fit: cover; display:none;">
                                        <source src="" type="video/mp4" id="videoUpload">
                                    </video>
                                    {{-- <a href="#" class="delImageNew mr-1"><img src="/assets/admin/img/closered.svg" width="25" /></a> --}}
                                </div>
                            </div>
                            <div class="upload-btn-wrapper">
                                ...
                                <input type="file" accept="video/*" onchange="videoRender(this, 'videoUpload')" name="product_video" id="product-video">
                            </div>
                            @error('product_video')
                            <label class="label">
                                <strong class="text-danger"> {{ $message }}</strong>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-11 offset-1">
                                    <input class="filled-in parent_check_{{ $productCategory->id }}"
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <input class="filled-in product_custom_size_id" name="product_custom_size_id"
                                        value="{{ $productCustomSize->id }}" type="checkbox"
                                        id="productCustomSize_{{ $productCustomSize->id }}">
                                    <label
                                        for="productCustomSize_{{ $productCustomSize->id }}">{{ $productCustomSize->title }}</label>
                                </div>
                                @endforeach
                            </div>
                        </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="md-form mt-0">
                                <input type="text" name="avg_lead_time" placeholder="Enter the Days here" value=""
                                    class="form-control">
                            </div>
                        </div>
                        @error('avg_lead_time')
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <select class="form-control" id="product_size_guide_id" name="product_size_guide_id">
                                    ...
                                    <option value="{{ $productSizeGuide->id }}">{{ $productSizeGuide->title }}</option>
                                    @endforeach
                                </select>
                            </div>
...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        $(document).on('click', '[data-request="generate-attribute"]', function () {
            ...
            set_generated_attributes +='<div class="col-lg-2">'+
                        '<div class="md-form">'+
                            '<input type="text" id="cost_'+number_index+'" placeholder="Price" name="varient['+number_index+'][cost]" class="form-control" value="">'+
                            '<label class="active" for="cost_'+number_index+'">Price</label>'+
                        '</div>'+
                    '</div>'+
                    '<div class="col-lg-2">'+
                        '<div class="md-form">'+
