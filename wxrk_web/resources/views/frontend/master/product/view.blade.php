            ...
            <div class="col-sm-12 col-md-12 col-12">
                <div class="tophead">
                    <div class="allTitle">
                        ...
                        <h2>View Product</h2>
                        <div class="subTitle">
                            View product, categories, sub-categories & attributes
                        </div>
                    </div>
                    <div class="headpanel">
                        <div class="setting">
                ...
                <div class="backbtnPanel nonflex">
                    ...
                    <div>
                        @if($product->status == 'pending')
                            <form style="display: none" role="approve-data" method="POST" redirect="/admin/products/{{ $product->id }}" action="/admin/update-product-status/{{ $product->id }}" enctype="multipart/form-data">
                        ...
                        @else
                            <div class="btn btn-sm btn-dark">{{ ucfirst($product->status) }}</div>
                        @endif
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-12">
                        <div class="myordersData">
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="md-form">
                                        <input type="text" readonly id="stitle" value="{{ $product->designer ? $product->designer->name : '' }}" class="form-control disabled">
                                        <label for="stitle">Designer Name</label>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="md-form">
                                        <input type="text" readonly id="stitle" name="title" value="{{ $product->title }}" placeholder="Enter the Title here" class="form-control">
                                                ...
                                                <div class="accordianPanel">
                                                    ...
                                                    <div class="collapse show">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-2">
                                                                <div class="md-form">
                                                                    <input type="text" readonly name="varient[{{ $key }}][attribute][{{ $varientOptions->product_attribute_id }}]" placeholder="{{ $varientOptions->attribute_name }}" class="form-control" value="{{ $varientOptions->option_name }}">
                                                            ...
                                                            <div class="col-lg-2">
                                                                <div class="md-form">
                                                                    <input type="text" readonly name="varient[{{ $key }}][cost]" placeholder="Cost" class="form-control" value="{{ $varients->cost }}">
                                                                    <label for="stitle">Cost in USD</label>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-2">
                                                                <div class="md-form">
                                                                    <input type="text" readonly name="varient[{{ $key }}][stock]" placeholder="Stock" class="form-control" value="{{ $varients->available_stock }}">
                                                    ...
                                                    <div class="collapse show" id="cat1">
                                                        <div class="row">
                                                            <div class="col-lg-2">
                                                                <div class="md-form">
                                                                    <input type="text" readonly id="stitle" placeholder="Cost" class="form-control" value="1000">
                                                                    <label for="stitle">Cost (In USD)</label>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-2">
            ...
            <section class="col-lg-4 connectedSortable">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                <img src="{{ $product->featured_image }}" id="preview_featured" class="border w-100 mb-2">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                <img src="{{ $product->featured_hover_image }}" id="preview_hover_featured" class="border w-100 mb-2">
                                {{-- <a href="#" class="delImageNew mr-1"><img src="/assets/admin/img/closered.svg" width="25" /></a> --}}
                            </div>
                        </div>
                        <!-- <div class="upload-btn-wrapper">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <!-- <div class="upload-btn-wrapper">
                            ...
                            <input type="file" onchange="videoRender(this, 'videoUpload')" name="product_video"" name="product_video" accept="video/*">
                        </div> -->
                        @error('product_video')
                            <label class="label">
                                <strong class="text-danger"> {{ $message }}</strong>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-12">
                                <input class="filled-in" name="category_id[]" onclick="checkChild(this)" {{ is_array($categories) && in_array($productCategory->id, $categories) ? 'checked' : '' }} disabled value="{{ $productCategory->id }}" type="checkbox" id="cat_{{ $productCategory->id }}">
                            ...
                            <div class="col-11 offset-1">
                                <input class="filled-in parent_check_{{ $productCategory->id }}" name="sub_category_id[]" value="{{ $child->id }}" {{ is_array($subCategories) && in_array($child->id, $subCategories) ? 'checked' : '' }} disabled type="checkbox" id="child_{{ $child->id }}">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-12">
                                <input class="filled-in product_custom_size_id" name="product_custom_size_id" {{ $productCustomSize->id ==$product->product_custom_size_id ? 'checked':''  }} value="{{ $productCustomSize->id }}" disabled type="checkbox" id="productCustomSize_{{ $productCustomSize->id }}">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                            ...
                            <input type="text" readonly name="avg_lead_time" placeholder="Enter the Days here" value="{{ $product->avg_lead_time }}" class="form-control">
                        </div>
                    </div>
                    @error('avg_lead_time')
                        <label class="label">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group"> 
                            <select disabled class="form-control" id="product_size_guide_id" name="product_size_guide_id">
...
<div class="modal fade rightModal" id="rejectModal" tabindex="-1" role="dialog" aria-labelledby="edittext" aria-hidden="true">
    <div class="modal-dialog modal-dialog-slideout" role="document">
        <div class="modal-content">
            <form role="post-data" method="POST" redirect="/admin/products/{{ $product->id }}" action="/admin/update-product-status/{{ $product->id }}" enctype="multipart/form-data">
...
<script type="text/javascript">
    ...
    $(document).on('click', '[data-request="generate-attribute"]', function () {
        ...
        $("input:checkbox[name=product_attributes]:checked").each(function(){
            ...
            set_generated_attributes +='<div class="col-lg-2">'+
                            '<div class="md-form">'+
                                '<input type="text" readonly class="form-control" name="varient['+number_index+'][attribute]['+attribute_id+']" placeholder="'+title+'" value="">'+
        ...
        set_generated_attributes +='<div class="col-lg-2">'+
                    '<div class="md-form">'+
                        '<input type="text" readonly id="cost_'+number_index+'" placeholder="Cost In USD" name="varient['+number_index+'][cost]" class="form-control" value="">'+
                        '<label class="active" for="cost_'+number_index+'">Cost In USD</label>'+
                    '</div>'+
                '</div>'+
                '<div class="col-lg-2">'+
                    '<div class="md-form">'+
                        '<input type="text" readonly id="stock_'+number_index+'" placeholder="Stock (QTY)" class="form-control" name="varient['+number_index+'][stock]" value="">'+
        ...
        '<div class="col-lg-1 text-center">'+
            ...
            '<div class="mb-4 row m-0 img_generated_row_'+number_index+'">'+
                ...
                '</div>'+
            '</div>';
        $('#set_generated_attributes').html(set_generated_attributes)
        number_index++;
    });
