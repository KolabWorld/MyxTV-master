                ...
                <div class="col-md-12">
                    <div class="row align-items-center">
                        ...
                        <div class="col-12 col-md-8 text-sm-right">
                            <a href="/event-type/create" class="btn btn-secondary btn-filter mr-2"><i
                                            ...
                                            <tbody>
                                                @foreach ($records as $record)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="/event-type/{{ $record->id }}/edit">
                                                                <i class="fas fa-pencil-alt"></i>
                                                            </a>
                                                            <a href="#" data-url="/event-type/{{ $record->id }}/delete"
                                                                data-request="remove" data-redirect="/event-types">
