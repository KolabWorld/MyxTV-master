                ...
                <div class="col-md-12">
                    <div class="row align-items-center">
                        ...
                        <div class="col-12 col-md-8 text-sm-right">
                            <a href="/price-view/create" class="btn btn-secondary btn-filter mr-2"><i
                                            ...
                                            <tbody>
                                                @foreach ($records as $record)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            {{ $record->from_date ? date('d M Y', strtotime($record->from_date)) : '' }}
                                                        </td>
                                                        <td>
                                                            {{ $record->to_date ? date('d M Y', strtotime($record->to_date)) : '' }}
                                                        </td>
                                                        <td>
                                                            {{ $record->offer_price_per_day }}
                                                        </td>
                                                        <td>
                                                            {{ $record->premium_price_per_day }}
                                                        </td>
                                                        <td>
                                                            <a href="/price-view/{{ $record->id }}/edit">
                                                                <i class="fas fa-pencil-alt"></i>
                                                            </a>
                                                            <a href="#" data-url="/price-view/{{ $record->id }}/delete"
                                                                data-request="remove" data-redirect="/price-views">
