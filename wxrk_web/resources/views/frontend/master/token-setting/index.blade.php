...
@section('content')
    ...
    @include('frontend.partials.nav', [
        'title' => 'pool-master',
        'description' => $tokenSettings->total() . ' Records',
    ])
                ...
                <div class="col-md-12">
                    <div class="row align-items-center">
                        ...
                        <div class="col-12 col-md-8 text-sm-right">
                            <a href="/token-setting/create" class="btn btn-secondary btn-filter mr-2"><i
                                ...
                                <div class="col-md-12">
                                    <div class="table-responsive">
                                        <table class="table dashtable">
                                            ...
                                            <tbody>
                                                @foreach ($tokenSettings as $tokenSetting)
                                                    <tr>
                                                        <td>
                                                            <span class="badge 
                                                            @if($tokenSetting->status == 'active')
                                                                badge-success
                                                            @elseif($tokenSetting->status == 'inactive')
                                                                badge-danger
                                                            @else
                                                                badge-warning
                                                            @endif
                                                            ">
                                                                {{ ucWords($tokenSetting->status) }}
                                                            </span>
                                                        </td>
                                                        <td>
                                                            {{ $tokenSetting->name }}
                                                        ...
                                                        <td>
                                                            <a href="/token-setting/{{ $tokenSetting->id }}/edit">
                                                                <i class="fas fa-pencil-alt"></i>
                                                            </a>
                                                            <a href="#" data-url="/token-setting/{{ $tokenSetting->id }}/delete"
                                                                data-request="remove" data-redirect="/token-settings">
                                    ...
                                    {{ $tokenSettings->links('frontend.layouts.pagination') }}
                                </div>
                            </div>
                        </div>
                    </div>
