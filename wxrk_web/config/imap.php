...
return [
    ...
    |
    */
    'default' => env('IMAP_DEFAULT_ACCOUNT', 'support'),
    ...
    */
    'accounts' => [
        ...
        'support' => [ // account identifier
            'host' => env('SUPPORT_IMAP_HOST', 'localhost'),
            'port' => env('SUPPORT_IMAP_PORT', 993),
            'encryption' => env('SUPPORT_IMAP_ENCRYPTION', 'ssl'),
            'validate_cert' => true,
            'username' => env('SUPPORT_IMAP_USERNAME', 'root@example.com'),
